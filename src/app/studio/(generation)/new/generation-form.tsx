...
export const GenerationForm = () => {
    ...
    type FieldName = keyof GenerationFormType;
    ...
    const handleFileUpload = async (file: File) => {
        const result = await getPresignedUrl({
            type: file.type as (typeof generationAssetConfig.allowedMimeTypes)[number],
    ...
    const onSubmit: SubmitHandler<GenerationFormType> = async (data) => {
        toast({
                                                ...
                                                <FormItem className="space-y-3">
                                                    ...
                                                    <FormControl>
                                                        <Input
                                                            ...
                                                            accept={generationAssetConfig.allowedMimeTypes.join(
                                                                ', ',
                                                            )}

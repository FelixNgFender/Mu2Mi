    ...
    return (
        <section className="container relative flex h-full flex-1 flex-col space-y-4 py-8">
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                the use of Mu2Mi&apos;s Website, located at https://mu2mi.com.
            </p>

            <p className="leading-7 [&:not(:first-child)]:mt-6">
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Mu2Mi if you do not agree to
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                accordance with and subject to, prevailing law of us. Any use of
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                We employ the use of cookies. By accessing Mu2Mi, you agreed to
                use cookies in agreement with the Mu2Mi&apos;s Privacy Policy.{' '}
            </p>
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                Unless otherwise stated, Mu2Mi and/or its licensors own the
                intellectual property rights for all material on Mu2Mi. All
                intellectual property rights are reserved. You may access this
                from Mu2Mi for your own personal use subjected to restrictions
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                website. Mu2Mi does not filter, edit, publish or review Comments
                prior to their presence on the website. Comments do not reflect
                the views and opinions of Mu2Mi,its agents and/or affiliates.
                ...
                laws, Mu2Mi shall not be liable for the Comments or for any
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                Mu2Mi reserves the right to monitor all Comments and to remove
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                You hereby grant Mu2Mi a non-exclusive license to use,
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                of Mu2Mi; and (d) the link is in the context of general resource
                information.
            </p>
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                by sending an e-mail to Mu2Mi. Please include your name, your
            ...
            <p className="leading-7 [&:not(:first-child)]:mt-6">
                No use of Mu2Mi&apos;s logo or other artwork will be allowed for

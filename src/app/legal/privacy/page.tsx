    ...
    return (
        <section className="container relative flex h-full flex-1 flex-col space-y-4 py-8">
            ...
            <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
                ...
                <li>
                    <p className="leading-7 [&:not(:first-child)]:mt-6">
                        <strong>Application</strong> refers to Mu2Mi, the
                ...
                <li>
                    <p className="leading-7 [&:not(:first-child)]:mt-6">
                        ...
                        &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                        or &quot;Our&quot; in this Agreement) refers to Mu2Mi.
                    </p>
                </li>
                <li>
                    <p className="leading-7 [&:not(:first-child)]:mt-6">
                ...
                <li>
                    <p className="leading-7 [&:not(:first-child)]:mt-6">
                        <strong>Country</strong> refers to: Massachusetts,
                        United States
                    </p>
                </li>
                <li>
                ...
                <li>
                    <p className="leading-7 [&:not(:first-child)]:mt-6">
                        <strong>Website</strong> refers to Mu2Mi, accessible
                        from{' '}
                        <a
                            href="https://mu2mi.com"

...
from demucs.apply import _replace_dict, apply_model
from demucs.audio import AudioFile, convert_audio, save_audio
from demucs.pretrained import REMOTE_ROOT, _parse_remote_files, get_model
from demucs.repo import BagOnlyRepo, LocalRepo, ModelOnlyRepo, RemoteRepo
...
class Separator:
    ...
    def separate_tensor(self, wav: th.Tensor, sr: Optional[int] = None) -> Tuple[th.Tensor, Dict[str, th.Tensor]]:
        """
